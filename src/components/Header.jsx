    ...
    <header className="w-full font-sans sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-xs border-b border-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex-shrink-0 flex items-center">
          <a 
            href="/" 
            className="text-2xl md:text-3xl font-normal tracking-wide text-brand-purple font-aclonica"
          >
            Dazzling Diva
          </a>
        </div>
        ...
        <nav className="hidden lg:flex items-center gap-6 xl:gap-8 font-medium">
          <a href="#home" className="text-brand-purple relative py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-brand-purple hover:after:w-full after:transition-all after:duration-300">
            Home
          </a>
          <a href="#shop" className="text-brand-purple relative py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-brand-purple hover:after:w-full after:transition-all after:duration-300">
            Shop
          </a>
          <a href="#three-piece" className="text-brand-purple relative py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-brand-purple hover:after:w-full after:transition-all after:duration-300">
            Three Piece
          </a>
          <a href="#two-piece" className="text-brand-purple relative py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-brand-purple hover:after:w-full after:transition-all after:duration-300">
            Two Piece
          </a>
          <a href="#hijab" className="text-brand-purple relative py-1 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-brand-purple hover:after:w-full after:transition-all after:duration-300">
            Hijab
          </a>
          ...
          <div className="flex items-center gap-3 ml-2">
            <a 
              href="#new-arrivals" 
              className="bg-brand-purple text-brand-yellow px-5 py-2.5 rounded-lg text-sm font-bold tracking-wide shadow-sm hover:shadow-md hover:scale-[1.03] active:scale-[0.98] transition-all duration-200 whitespace-nowrap"
            >
              New Arrivals
            </a>
            <a 
              href="#deals" 
              className="bg-brand-yellow text-brand-purple px-5 py-2.5 rounded-lg text-sm font-bold tracking-wide shadow-sm hover:shadow-md hover:scale-[1.03] active:scale-[0.98] transition-all duration-200 whitespace-nowrap"
            >
              Deals & Offers
            </a>
          </div>
          ...
          <div className="px-4 pt-4 pb-6 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a 
                href="#new-arrivals" 
                onClick={() => setIsMobileMenuOpen(false)}
                className="w-full bg-brand-purple text-brand-yellow text-center py-3 rounded-lg font-bold tracking-wide shadow-xs active:scale-98 transition-all block"
              >
                New Arrivals
              </a>
              <a 
                href="#deals" 
                onClick={() => setIsMobileMenuOpen(false)}
                className="w-full bg-brand-yellow text-brand-purple text-center py-3 rounded-lg font-bold tracking-wide shadow-xs active:scale-98 transition-all block"
              >
                Deals & Offers
              </a>
            </div>
